...
public:
    ...
    and take one extra pointer previous to handle the required case
    Time: O(N), Space: O(N)*/
...
public:
    ...
    left node to right, it would better you draw on the paper and observe it.
    Time: O(N)*/
